...
setwd("~/Bios301Work/Final_Project")
...
batch_results <- read.csv("../Final_Project/Pconcolor_batch1.csv")
volume_fill_results <- read.csv("../Final_Project/Pconcolor_batch1VolumeFillResults.csv")
Hasfc_results <- read.csv("../Final_Project/Pconcolor_batch1_AS_auto-split-stats.csv")
